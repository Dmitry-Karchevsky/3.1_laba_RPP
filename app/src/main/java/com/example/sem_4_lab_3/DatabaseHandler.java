...
public class DatabaseHandler extends SQLiteOpenHelper implements IDatabaseHandler {
    ...
    private static final String CREATE_TABLE_STUDENT2 = "CREATE TABLE " + TABLE_STUDENT + "(" +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        int id;
        String name, name_s, second_name, part, date;
        ...
        if (oldVersion == 1 && newVersion == 2) {
            ...
            for (Student st : students) {
                ...
                values.put(KEY_NAME, name_s);
                values.put(KEY_SECOND_NAME, second_name);
                values.put(KEY_PATR, part);
